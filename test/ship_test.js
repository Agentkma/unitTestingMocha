...
describe('checkForShip', ()=>{
    ...
    let player;
    // user before() b/c player obj is NOT modified by checkForShip func
    before( ()=>{
        player = {
            ships: [
                {
...
describe('damageShip', ()=>{
    ...
    it('should register damage on a given ship at a given location', ()=>{
        ...
        expect(ship.damage[0]).to.deep.equal
...
describe('fire', ()=>{
    ...
    let player;
    // use beforeEach() b/c the player obj is modified by fire func
    beforeEach(()=>{
        player = {
            ships: [
                {
    ...
    it('should NOT record damage if ther is no ship at my coordinates', ()=>{
